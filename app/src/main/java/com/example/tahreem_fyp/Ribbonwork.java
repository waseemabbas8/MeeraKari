...
public class Ribbonwork extends AppCompatActivity {
...
//        ArrayList<com.example.tahreem_fyp.RecyclerView> list = new ArrayList<>();
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new recyclerviewsubcatadapter(list1, Ribbonwork.this);
                recyclersub.setAdapter(adapter);
                Toast.makeText(Ribbonwork.this, "size : " + list.size(), Toast.LENGTH_SHORT).show();
