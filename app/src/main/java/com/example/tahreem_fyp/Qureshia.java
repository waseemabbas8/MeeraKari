...
public class Qureshia extends AppCompatActivity {
...
//        ArrayList<com.example.tahreem_fyp.RecyclerView> list = new ArrayList<>();
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new recyclerviewsubcatadapter(list1, Qureshia.this);
                recyclersub.setAdapter(adapter);
                Toast.makeText(Qureshia.this, "size : " + list.size(), Toast.LENGTH_SHORT).show();
