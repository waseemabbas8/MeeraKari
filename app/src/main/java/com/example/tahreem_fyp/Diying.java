...
public class Diying extends AppCompatActivity {
...
//        ArrayList<com.example.tahreem_fyp.RecyclerView> list = new ArrayList<>();
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new recyclerviewsubcatadapter(list1, Diying.this);
                recyclersub.setAdapter(adapter);
                Toast.makeText(Diying.this, "size : " + list.size(), Toast.LENGTH_SHORT).show();
